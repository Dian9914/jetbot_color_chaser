...
class central_node():
    def __init__(self):
        ...
        self.max_lin = rospy.get_param('max_lin_vel', 1)    #velocidad lineal maxima a la que se persiguen objetos
        self.max_ang = rospy.get_param('max_ang_vel', 1)      #velocidad angular maxima a la que se persiguen objetos
    ...
    def process_data(self, data):
        ...
        if abs(err_pos)<10:
            ...
            ang_vel=err_pos/abs(err_pos)*self.max_ang
        elif err_pos<0:
